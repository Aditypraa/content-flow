            ...
            <div className="p-4 lg:px-6 lg:pt-6">
                <div className="w-full flex-1 bg-gray-50 border-b border-slate-200 flex justify-center items-start">
                    <div className="w-[400px] px-4 py-6 bg-white rounded-xl flex flex-col justify-center items-center gap-9">
                        <div className="self-stretch text-center text-slate-900 text-xl font-semibold leading-7">User Profile</div>
                                ...
                                <div className="self-stretch px-3 py-2.5 bg-gray-100 rounded-md border border-slate-200 flex justify-between items-center">
                                    <div className="flex justify-start items-center gap-4">
                                        <div className="flex justify-start items-center gap-2">
                                            <div className="text-gray-900 text-base font-semibold">Username</div>
                                        </div>
                                        <div className="flex justify-start items-center gap-2">
                                            <div className="text-gray-900 text-base font-normal">:</div>
                                        </div>
                                    </div>
                                    <div className="w-[210px] text-center text-slate-900 text-base font-normal">James Dean</div>
                                </div>

                                <div className="self-stretch px-3 py-2.5 bg-gray-100 rounded-md border border-slate-200 flex justify-between items-center">
                                    <div className="flex justify-start items-center gap-4">
                                        <div className="w-[75px] flex justify-start items-center gap-2">
                                            <div className="text-gray-900 text-base font-semibold">Password</div>
                                        </div>
                                        <div className="flex justify-start items-center gap-2">
                                            <div className="text-gray-900 text-base font-normal">:</div>
                                        </div>
                                    </div>
                                    <div className="w-[210px] text-center text-slate-900 text-base font-normal">Admin123</div>
                                </div>

                                <div className="self-stretch px-3 py-2.5 bg-gray-100 rounded-md border border-slate-200 flex justify-between items-center">
                                    <div className="flex justify-start items-center gap-4">
                                        <div className="w-[75px] flex justify-start items-center gap-2">
                                            <div className="text-gray-900 text-base font-semibold">Role</div>
                                        </div>
                                        <div className="flex justify-start items-center gap-2">
                                            <div className="text-gray-900 text-base font-normal">:</div>
                                        </div>
                                    </div>
                                    <div className="w-[210px] text-center text-slate-900 text-base font-normal">Admin</div>
                                </div>
                            </div>
                        </div>
