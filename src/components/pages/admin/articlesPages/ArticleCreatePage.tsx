    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        <AdminLayout activeMenu="articles" title="Articles">
            ...
            <div className="p-4 lg:px-6 lg:pt-6">
                <div className="w-full max-w-none lg:max-w-4xl lg:mx-auto">
                        ...
                        <CardContent className="p-4 lg:p-6 space-y-4 lg:space-y-6">
                            <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
                                ...
                                <Card className="h-[400px] lg:h-[551px] bg-gray-50 border-slate-200 flex flex-col">
                                    ...
                                    {/* Word Count */}
                                    <div className="px-3 lg:px-4 py-4 lg:py-6 bg-white border-t border-slate-200">
                                ...
                                <div className="py-4 flex flex-col sm:flex-row justify-end gap-2">
                                    ...
                                    <Button type="button" variant="secondary" className="w-full sm:w-auto bg-slate-200 text-slate-900">
                                        Preview
                                    </Button>
