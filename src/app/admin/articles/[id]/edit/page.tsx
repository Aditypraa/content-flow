...
export default function ArticleEdit() {
  const [content, setContent] =
    useState(`In the ever-evolving world of digital product design, collaboration between designers and developers has always been a crucial—yet often challenging—part of the process. In April 2025, Figma introduced Dev Mode, a powerful new feature aimed at streamlining that collaboration more than ever before.
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <CustomTipTapEditor content={content} onChange={setContent} />
                <div className="flex justify-between items-center text-xs text-gray-500">
                  <p id="content-description">
                    Write your article content using rich text formatting tools
                    above.
                  </p>
